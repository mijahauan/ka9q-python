...
Validated against ka9q-radio commit: deb7bddf777d
...
class StatusType:
    ...
    LIFETIME = 117  # frames until channel goes away
...
class DemodType:
    ...
    IDLE_DEMOD = 5  # placeholder that just processes commands
    N_DEMOD = 6  # Dummy equal to number of valid entries
